...
Playerwalkinganim = [pygame.image.load("Wizardwalk1.png"),pygame.image.load("Wizardwalk2.png"),pygame.image.load("Wizardwalk3.png"),pygame.image.load("Wizardwalk4.png")]
